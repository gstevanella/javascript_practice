...
// then stick it inside a <div> in the html
  ...
  const map = L.map('map', {
    center: [46.3633,13.037,8], // EDIT latitude, longitude to re-center map
 ...
 let popupContent = "<p>"+"In this point/area: "+row.EventLocationName+" an "+row.EventType+"<p> <img src='"+imagePopup+"' width='150px'> </p>"+"</p>" ;
